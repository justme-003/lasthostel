...
import 'package:hostel_management/features/student/screens/availiblity.dart';
        ...
        child: Padding(
          ...
          child: Column(
            children: [
                  ...
                  : Container(
                      ...
                      decoration: const ShapeDecoration(
                        ...
                        shape: RoundedRectangleBorder(
                          side: BorderSide(
                              width: 2,
                              color: Color.fromARGB(255, 51, 54, 227)),
                        ...
                        shadows: [
                          BoxShadow(
                            color: Color.fromARGB(184, 31, 96, 217),
                            blurRadius: 8,
                            offset: Offset(2, 4),
                            spreadRadius: 0,
                          ),
              ...
              Container(
                width: double.maxFinite,
                color: Color.fromARGB(36, 16, 89, 234),
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    heightSpacer(20),
                    Padding(
                      ...
                      child: Text(
                        ...
                        textAlign: TextAlign.center,
                        style: TextStyle(
                          color: Color.fromARGB(248, 16, 105, 228),
                          fontSize: 17.sp,
                          fontWeight: FontWeight.w700,
                        ),
                      ),
                        ...
                        CategoryCard(
                          ...
                          onTap: () {
                            Navigator.push(
                              context,
                              CupertinoPageRoute(
                                builder: (context) => const Ava(),
                              ), // CupertinoPageRoute
                            );
                          },
                          image: AppConstants.info,
                        ), // Categor
                      ],
                    ),
                  ],
