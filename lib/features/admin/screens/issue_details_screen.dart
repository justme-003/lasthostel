...
class _IssueScreenState extends State<IssueScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: buildAppBar(context, 'Студенттер мәселелері'),
      body: FutureBuilder(
        future: fetchIssues(),
          ...
          Container(
            decoration: ShapeDecoration(
              gradient: LinearGradient(
                ...
                colors: [
                  Color.fromARGB(255, 25, 116, 214).withOpacity(0.5),
              ...
              children: [
                ...
                Column(
                  ...
                  children: [
                    heightSpacer(10.0),
                    Text(
                      'Пайдаланушы аты: ${issue.studentDetails.firstName}',
                      style: TextStyle(
                        color: const Color(0xFF333333),
                        fontSize: 14.sp,
                      ),
                    ...
                    heightSpacer(8.0),
                    Text('Бөлме нөмірі: ${issue.roomDetails.roomNumber}'),
                    heightSpacer(8.0),
                    SizedBox(
                      width: 160.w,
                      child: Text(
                    ...
                    heightSpacer(8.0),
                    Text(
                        'Телефон нөмірі.: ${issue.studentDetails.phoneNumber}'),
                  ],
                ),
              ],
            ),
