...
class _RoomChangeRequestScreenState extends State<RoomChangeRequestScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: buildAppBar(context, 'Бөлме ауыстыру сұраныстары'),
              ...
              builder: (context, snapshot) {
                if (snapshot.connectionState == ConnectionState.waiting) {
                  ...
                  return roomModel == null
                      ? const Center(
                          child: Text(
                            "Бөлме ауыстыру сұраныстары табылмады",
                          ),
                        )
                      : ListView.builder(
          ...
          Container(
            decoration: ShapeDecoration(
              gradient: LinearGradient(
                ...
                colors: [
                  Color.fromARGB(255, 31, 105, 232).withOpacity(0.5),
              ...
              children: [
                ...
                Column(
                  ...
                  children: [
                    heightSpacer(10.0),
                    Text(
                      'Пайдаланушы аты: ${request.studentDetails.firstName}',
                      style: TextStyle(
                        color: const Color(0xFF333333),
                        fontSize: 14.sp,
                      ),
                    ...
                    heightSpacer(8.0),
                    Text('Ағымдағы бөлме: ${request.currentRoomNumber}'),
                    heightSpacer(8.0),
                    Text('Ағымдағы қабат: ${request.currentBlock}'),
                    heightSpacer(8.0),
                    SizedBox(
                      width: 160.w,
                      child: Text(
                        'Email : ${request.studentDetails.emailId}',
                        overflow: TextOverflow.ellipsis,
                      ),
                    ),
                    heightSpacer(8.0),
                    Text(
                        'Телеофон нөмірі.: ${request.studentDetails.phoneNumber}'),
                  ],
                ),
              ],
            ),
                              ...
                              children: [
                                ...
                                Row(
                                  ...
                                  children: [
                                    ...
                                    widthSpacer(20),
                                    Text(
                                      "Бөлме  : ${request.toChangeRoomNumber}",
                                      textAlign: TextAlign.center,
                                      style: TextStyle(
                                        color: Colors.pink,
                                        fontSize: 16.sp,
