...
class _ChangeRoomScreenState extends State<ChangeRoomScreen> {
  ...
  List<String> blockOptions = ['1', '2', '3', '4'];
  List<String> roomOptionsA = ['101', '102', '103'];
  List<String> roomOptionsB = ['201', '202', '203'];
  List<String> roomOptionsC = ['301', '302', '303'];
  List<String> roomOptionsF = ['401', '402', '403'];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: buildAppBar(context, 'Бөлме ауыстыру'),
      body: Column(
        children: [
          Container(
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  heightSpacer(20),
                  Text(
                    'Ағымдағы қабат нөмірі және бөлме нөмірі.',
                    style: TextStyle(
                    ...
                    children: [
                          ...
                          decoration: ShapeDecoration(
                            shape: RoundedRectangleBorder(
                              side: const BorderSide(
                                  width: 1,
                                  color: Color.fromARGB(255, 40, 106, 221)),
                              borderRadius: BorderRadius.circular(14),
                            ),
                          ),
                          child: Text(
                            'Бөлме нөмірі - ${ApiUrls.roomNumber}',
                      ...
                      Expanded(
                        child: Container(
                          ...
                          child: Text(
                            'Қабат нөмірі - ${ApiUrls.blockNumber}',
                            textAlign: TextAlign.center,
                            style: TextStyle(
                              color: const Color(0xFF333333),
                              fontSize: 17.sp,
                  ...
                  heightSpacer(20),
                  Text(
                    'Қабат және бөлме нөмірін таңдаңыз.',
                    style: TextStyle(
                      color: const Color(0xFF464646),
                      fontSize: 16.sp,
                      fontWeight: FontWeight.w700,
