...
class _RoomAvailabilityScreenState extends State<RoomAvailabilityScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: buildAppBar(context, 'Бөлмелер қолжетімділігі'),
      body: FutureBuilder(
        future: fetchData(),
      ...
      decoration: ShapeDecoration(
        ...
        shape: RoundedRectangleBorder(
          side: const BorderSide(
              width: 2, color: Color.fromARGB(255, 67, 56, 227)),
        ...
        children: [
          ...
          Column(
            ...
            children: [
              ...
              heightSpacer(5),
              Text(
                'Қәзіргі студент саны: ${room.roomCurrentCapacity}',
                style: TextStyle(
                  color: const Color(0xFF333333),
                  fontSize: 16.sp,
                ),
